...
CODESPACE_BACKEND_HOST=$(curl -s "https://nivri.ngrok.io/api/v1/codespace/backend-host?codespaceName=${CODESPACE_NAME}&portForwarding=${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}" | jq -r '.codespaceBackendHost')
